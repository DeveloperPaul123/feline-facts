...
class CatTriviaModel extends CatTrivia {
  ...
  factory CatTriviaModel.fromMap(Map<dynamic, dynamic> jsonMap) {
    int factLength = -1;
    ...
    return CatTriviaModel(fact: jsonMap['fact'], factLength: factLength);
  }

  Map<String, dynamic> toMap() {
    return {'fact': fact, 'length': factLength};
  }
}
